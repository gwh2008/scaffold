...
import com.gaowh.scaffold.modular.system.dao.DictDao;
import com.gaowh.scaffold.modular.system.service.IDictService;
import com.gaowh.scaffold.modular.system.warpper.DictWarpper;
import com.gaowh.scaffold.common.persistence.dao.DictMapper;
...
public class DictController extends BaseController {
     ...
     */
    @BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = com.gaowh.scaffold.common.constant.Dict.DictMap)
     ...
     * 修改字典
     */
    @BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = com.gaowh.scaffold.common.constant.Dict.DictMap)
     ...
     * 删除字典记录
     */
    @BussinessLog(value = "删除字典记录", key = "dictId", dict = com.gaowh.scaffold.common.constant.Dict.DeleteDict)
