package com.gaowh.scaffold.core.template.engine.base;
 ...
 */
public abstract class ScaffoldTemplateEngine extends AbstractTemplateEngine {

    protected GroupTemplate groupTemplate;

    public ScaffoldTemplateEngine() {
        initBeetlEngine();
    }
