...
import com.gaowh.scaffold.common.constant.dictmap.factory.DictMapFactory;
...
import com.gaowh.scaffold.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.gaowh.scaffold.common.annotion.log.BussinessLog)")
